...
module.exports.handleEvent = async function({
	...
	if ((void 0 === i.resend || 0 != i.resend) && l != global.data.botID && ("message_unsend" != e.type && global.logMessage.set(g, {
		...
		if (null == m.attachment[0]) return a.sendMessage(`${e} đã gỡ 1 tin nhắn nhưng mà không nhanh bằng min đâu nhé💢🔪🔪🔪\nNội dung: ${m.msgBody}`, u); {
			let t = 0,
				s = {
					body: `${e} vừa gỡ ${m.attachment.length} tệp đính kèm nhưng mà nhanh thế nào bằng min hay dỗi được chứ hihi yêu các bạn💢💢 =)))))) .${""!=m.msgBody?`\n\nNội dung: ${m.msgBody}`:""}`,
					attachment: [],
					mentions: {
						tag: e,
						id: l
