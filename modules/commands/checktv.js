...
module.exports.run = async ({ api, event, args, Currencies, Users }) => {
    ...
    body: msg, attachment: (await axios.get((await axios.get(`https://api-anh.vtuann.repl.co/du`)).data.data, {
                    responseType: 'stream'
                })).data
}, event.threadID);
	} else if(mention[0]) {
